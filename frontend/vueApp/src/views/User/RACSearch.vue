                        ...
                        <v-flex>
                            <v-card height="100%" dark>
                                <v-card-text>
                                    <v-layout row>
                                        <v-flex xs2>
                                            <img width="100%" height="100%" v-bind:src='"http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/" + item.Picture'>
                                        </v-flex>
                                        <v-flex xs8>
                                            <v-layout row >
                                                <div class="headline">
    ...
    export default {
        ...
        methods: {
            ...
            racSearch(e) {
                ...
                axios.create({withCredentials: true}).post("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/search/rac", SearchQuery).
                    then(res => {
                        this.items = res.data;
