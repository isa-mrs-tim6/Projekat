...
<script>
    ...
    export default {
        ...
        beforeCreate() {
            axios.create({withCredentials: true}).get("http://localhost:8000/api/airplane/getAirplanesAndSeats")
                .then(res => {
                    this.items = res.data;
                })
        },
        ...
        methods: {
            ...
            addAirplane(){
                ...
                axios.create({withCredentials: true}).post("http://localhost:8000/api/airplane/addAirplane", params)
                    .then(res => {
                        axios.create({withCredentials: true}).get("http://localhost:8000/api/airplane/getAirplanesAndSeats")
                            .then(res => {
                                this.clear();
