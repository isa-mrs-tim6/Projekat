...
<script>
    ...
    export default {
        ...
        created(){
            axios.create({withCredentials: true}).get("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/flight/getCompanyFlights")
                .then(res => {
        ...
        methods:{
            ...
            save(){
                ...
                axios.create({withCredentials: true}).post("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/priceList/update", flight)
                    .then(res => {
                        axios.create({withCredentials: true}).get("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/flight/getCompanyFlights")
                            .then(res => {
                                this.flights = res.data;
            ...
            saveSeats(){
                ...
                axios.create({withCredentials: true}).post("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/flight/updateSeats", flight)
                    .then(res => {
                        axios.create({withCredentials: true}).get("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/flight/getCompanyFlights")
                            .then(res => {
                                this.flights = res.data;
