...
<script>
    ...
    export default {
        ...
        mounted() {
            axios.create({withCredentials: true}).get('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/reservations/rewards')
                .then(res => {
        ...
        methods: {
            ...
            changeRewards(e) {
                ...
                axios.create({withCredentials: true}).put('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/reservations/rewards', this.rewards)
                    .then(res => {
                        this.backup = JSON.parse(JSON.stringify(this.rewards));
                    })
