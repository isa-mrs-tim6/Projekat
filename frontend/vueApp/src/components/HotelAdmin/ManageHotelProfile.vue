        ...
        mounted() {
            axios.create({withCredentials: true}).get('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/getProfile')
                .then(res => {
                        ...
                        this.PictureLink = 'http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/'+this.hotelProfile.Picture;
        ...
        methods: {
            update(e) {
                ...
                if (isNaN(Number(this.hotelProfile.Longitude)) && isNaN(Number(this.hotelProfile.Latitude))){
                    ...
                    axios.create({withCredentials: true}).post('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/updateProfile', this.hotelProfile)
                        .then(res => {
                            this.backupHotelProfile = JSON.parse(JSON.stringify(this.hotelProfile))
            ...
            updatePicture(e){
                ...
                axios.create({withCredentials: true}).post( 'http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/upload/updateHotelProfilePicture',
                    formData,
                    {
                        headers: {
