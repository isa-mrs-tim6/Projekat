...
<script>
    ...
    export default {
        ...
        mounted() {
            axios.create({withCredentials: true}).get('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/rewards')
                .then(res => {
                    this.rewards = res.data;
                    this.backup = JSON.parse(JSON.stringify(this.rewards));
                })
                .catch(err => alert("Could not retrieve hotel rewards"));
            axios.create({withCredentials: true}).get('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/features')
                .then(res => {
        ...
        methods: {
            addFeature(index) {
                ...
                axios.create({withCredentials: true}).post('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/rewards', this.new_rewards[index])
                    .then(res => {
            ...
            updateFeature(index) {
                ...
                axios.create({withCredentials: true}).put('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/rewards', this.rewards[index])
                    .then(res => {
                        this.backup = JSON.parse(JSON.stringify(this.rewards));
                    })
            ...
            deleteFeature(index) {
                axios.create({withCredentials: true}).delete('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/rewards', { data: this.rewards[index] })
                    .then(res => {
