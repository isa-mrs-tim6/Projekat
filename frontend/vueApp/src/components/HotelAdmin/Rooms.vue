    ...
    export default {
        ...
        methods: {
            ...
            saveQuickReserve() {
                ...
                axios.create({withCredentials: true}).put('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/updateQuickReserveDays', quickReserveDays);
            },
        },
    }
</script>
