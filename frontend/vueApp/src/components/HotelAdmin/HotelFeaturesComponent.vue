    ...
    export default {
        ...
        methods: {
            ...
            addFeature(index) {
                ...
                axios.create({withCredentials: true}).post('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/features', this.new_features[index])
                    .then(res => {
                        this.getFeatures();
            ...
            updateFeature(index) {
                ...
                axios.create({withCredentials: true}).put('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/features', this.features[index])
                    .then(res => {
                        this.backup = JSON.parse(JSON.stringify(this.features));
                    })
            ...
            deleteFeature(index) {
                axios.create({withCredentials: true}).delete('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/features', { data: this.features[index] })
                    .then(res => {
