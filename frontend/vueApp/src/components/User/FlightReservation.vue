...
<script>
    ...
    export default {
        ...
        created(){
            axios.get("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/flight/"+ this.flightId +"/getFlight")
                 .then(res =>{
        ...
        methods:{
            ...
            reserve(e) {
                ...
                axios.create({withCredentials: true}).post('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/reservations/airline/reserve/q='+this.flightId, payload)
                    .then(res => {
                        if (res.status === 200) {
