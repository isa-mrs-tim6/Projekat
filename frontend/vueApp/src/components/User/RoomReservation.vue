...
<script>
    ...
    export default {
        ...
        created() {
            axios.create({withCredentials: true}).get('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/hotel/' + this.hotelID + '/getRoomCapacities')
                .then(res => {
        ...
        methods: {
            search: function (query) {
                ...
                axios.create({withCredentials: true}).post('http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/search/' + this.hotelID + '/rooms', query)
                    .then(res => {
                        this.rooms = res.data;
                        this.checkboxes = [];
                        this.searched = true;
