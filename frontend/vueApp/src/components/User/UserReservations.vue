...
<script>
    ...
    export default {
        ...
        beforeCreate() {
            axios.create({withCredentials: true}).get("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/reservations/getReservations").
            then(res => {
                ...
                axios.create({withCredentials: true}).get("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/user/getScale")
                    .then(res2 => {
        ...
        methods : {
            ...
            accept(reservation){
                axios.create({withCredentials: true}).get("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/user/accept/"+reservation.ID)
                    .then(res => {
                        this.$router.go();
                    })
            },
            ...
            cancelFlight(reservation){
                axios.create({withCredentials: true}).get("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/user/cancelFlight/"+reservation.ID)
                    .then(res => {
                        this.$router.go();
                    })
            },
            cancelHotel(reservation){
                axios.create({withCredentials: true}).get("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/user/cancelHotel/"+reservation.ID)
                    .then(res => {
                        this.$router.go();
                    })
            },
            cancelRAC(reservation){
                axios.create({withCredentials: true}).get("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/user/cancelVehicle/"+reservation.ID)
                    .then(res => {
                        this.$router.go();
                    })
            },
                ...
                switch (this.rateType) {
                    case 'flight':
                        if(moment(this.landing, 'DD.MM.YYYY HH:mm').isAfter(moment())){
                            ...
                            axios.create({withCredentials: true}).post("http://ec2-18-195-170-20.eu-central-1.compute.amazonaws.com:8000/api/user/rate", rating)
                                .then(res => {
